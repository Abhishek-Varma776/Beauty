    ...
    if (step === 1) {
      ...
      const upiApps: { id: "gpay" | "phonepe" | "paytm" | "generic"; label: string; iconHtml: string; color: string }[] = [
        ...
        },
        {
          ...
          label: "PhonePe",
          iconHtml: `
            <svg fill="#5F259F" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="28" height="28" style="display:block;margin-bottom:0.4rem">
